...
import { FONTS, COLORS, images, SIZES, icons } from '../constants'
...
const IconLabel = ({ icon, label }) => {
    return (
        <View style={{ alignItems: 'center' }}>
            ...
            />
            <Text style={{ marginTop: SIZES.padding, color: COLORS.darkgray, ...FONTS.h3 }}>{label}</Text>
        </View>
    )
}
const DestinationDetails = ({ navigation }) => {
    return (
        ...
        >
            <View style={{ flex: 2 }}>
                ...
                >
                    <View style={{ flexDirection: 'row' }}>
                        <View style={[styles.shadow, { borderRadius: SIZES.radius * .5 }]}>
                            <Image
                        ...
                        <View style={{ marginHorizontal: SIZES.padding, justifyContent: 'space-around' }}>
                            ...
                            <Text style={{ color: COLORS.darkgray, ...FONTS.body3 }}>France</Text>
                            <StarReview rate={4.5} />
                        </View>
                    </View>
            ...
            <View style={{ flex: 1.5 }}>
                <View style={{ flexDirection: 'row', marginTop: SIZES.base, paddingHorizontal: SIZES.padding * 3, justifyContent: 'space-between' }}>
                    <IconLabel
                        icon={icons.villa}
                        label="Villa"
                    />
                ...
                {/* About */}
                <View style={{ marginTop: SIZES.padding, paddingHorizontal: SIZES.padding * 2 }}>
                    <Text style={{ ...FONTS.h2 }}>About</Text>
                    <Text style={{ marginTop: SIZES.padding, color: COLORS.darkgray, ...FONTS.body3 }}>
            ...
            <View style={{ flex: 0.5, paddingHorizontal: SIZES.padding }}>
                <LinearGradient
                    style={[{marginTop:SIZES.base, height: "70%", width: '100%', borderRadius: 15 }]}
                    colors={['#edf0fc', '#d6dfff']}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 0 }}
                >
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ flex: 1, marginHorizontal: SIZES.padding * 2, justifyContent: 'center' }}>
                            <Text style={{ ...FONTS.h1 }}>$1000</Text>
                        </View>

                        <TouchableOpacity
                            style={{ width: 130, height: '80%', marginHorizontal: SIZES.padding2 }}
